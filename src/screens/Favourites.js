//= LIST OF HILLS USER WANTS TO HIKE
...
const Favourites = ({navigation, props}) => {
    ...
    const URL = "http://localhost:3000/hill/hillsToHike"
    ...
    const fetchData = async () =>{
        ...
        console.log('Hills to hike for '+ firstName)
      ...
      const functionComplete = ()=>{
        ...
        return(
            ...
            <View style ={styles.headerStyle}>
              <View>
                <View>
                    <Text style={{fontWeight:'bold', fontSize:23, fontFamily:'exoBlack', color:'white'}}>{item.hillName}</Text>
                </View>
                <View style={styles.rowContainer}>
                    <AntDesign name="checkcircleo" size={35} color={isCompleteStatus ? 'white' : '#4ce44c'} onPress={() => functionComplete()}/>
                    <Text>     </Text>
                    <AntDesign name="delete" size={35} color="white" onPress={() => removeHillsToHike()}/>
                </View>  
      ...
      <KeyboardAvoidingView style={styles.headContainer}>
        <View style={styles.rowHeaderContainer}>
            <Text style={{fontFamily: "exoLight", fontWeight:'bold',
                marginTop:3, marginLeft:5, fontSize:20, marginBottom:10}}>List of hills you have favourited: </Text>      
        </View>
