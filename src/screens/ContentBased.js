//Description: Page that displayes Content-Based Recommendation result
...
const ContentBased = ({navigation, props}) => {
...
const URL = "http://localhost:3000/hill/completed/cb"
...
const fetchData = async () =>{
  ...
  console.log('Content-Based: '+ firstName)
...
return (
  ...
  >
  <LinearGradient
        colors={['#00B2EE', '#FFFFFF','transparent']}
        style={styles.mainContainer}    
    />
    <KeyboardAvoidingView style={styles.headContainer}> 
    <View style={styles.rowHeaderContainer}>
        <Text style={{fontFamily: "exoLight", fontWeight:'bold',
            marginTop:3, marginLeft:5, fontSize:18, marginBottom:10}}>Hi, {firstName}. Based on your recent hiking visit, here are some
              locations that may interest you: </Text>
    </View>
