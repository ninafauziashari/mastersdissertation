...
const HillsHiked = ({navigation, props}) => {
    ...
    const URL = "http://localhost:3000/hill/completedHill"
    ...
    const fetchData = async () =>{
        ...
        console.log('Hills hiked for '+ firstName)
        fetch(URL ,{
            method:"POST",
            headers: {
            ...
            try{
              ...
              .then(async (responseJson) =>{
                try{
                  ...
                  console.log('Woops '+ firstName+' did not visit '+ hillName)
      ...
      return(
        ...
        <View style ={styles.headerStyle}>
          <View style={styles.rowContainer}>
            <Text style={{fontWeight:'bold', fontSize:24, alignSelf:'flex-start', fontFamily:'exoBlack', color:'white'}}>{item.hillName}</Text>
            <Text>   </Text>
            <AntDesign name="delete" size={35} color="white" onPress={() => functionRemoveCompletedHills()}/>
          </View>
        </View>
    ...
    >
    <LinearGradient
          colors={['#17E03A', '#8B4513','transparent']}
      ...
      <View style={styles.rowContainer}>
          <Text style={{fontFamily: "exoLight", fontWeight:'bold',
              marginTop:3, marginLeft:5, fontSize:20, marginBottom:10}}>List of hills you have hiked: </Text>  
      </View>
